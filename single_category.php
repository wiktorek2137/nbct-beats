...
<head>
    ...
    <title>NBCT SINGLE CATEGORY</title>
        ...
        <div class="beat-container-section">
            ...
            <div class="beat-info-el">
                ...
                <div class="category-info-title">
                    <a id="category-name">NAZWA KATEGORII</a>
                </div>
            ...
            <div class="beat-content-futured">
                <div class="futured-section-info">
                    ...
                    <div class="futured-section-desc">
                        <a>Zobacz nasze produkcje z wybranej kategorii</a>
                    </div>
                </div>
...
<!-- PLAYER -->
    ...
    <script src="js/single_category.js"></script>
</body>
</html>