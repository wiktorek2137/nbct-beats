...
$producerBeatNewest_query = "SELECT * FROM beaty INNER JOIN producers ON beaty.beat_autor=producers.producer_id WHERE beat_autor = '$producerID' ORDER BY beat_count DESC LIMIT 4";
